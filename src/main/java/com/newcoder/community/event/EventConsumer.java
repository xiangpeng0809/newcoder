...
public class EventConsumer implements CommunityConstant {
    ...
    class UploadTask implements Runnable {
        ...
        public void run() {
            ...
            if (file.exists()) {
                logger.error(String.format("开始第%d次上传[%s]", ++uploadTimes, fileName));
                // 设置响应信息
                ...
                try {
                    ...
                    Response response = manager.put(
                            path, fileName, uploadToken,null,"images/" + suffix, false);
                    // 处理响应结果
